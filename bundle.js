...
/***/ function(module, exports, __webpack_require__) {
	...
	var App = function (_React$Component) {
	  ...
	  function App(props) {
	    ...
	    _this.setCohort = _this.setCohort.bind(_this);
	    return _this;
	  }

	  _createClass(App, [{
	    key: 'setCohort',
	    value: function setCohort(cohort) {
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          'button',
	          { onClick: this.setCohort.bind(null, 37) },
	          '37'
	        ),
	        _react2.default.createElement(
	          'button',
	          { onClick: this.setCohort.bind(null, 38) },
	          '38'
	        ),
	        _react2.default.createElement(
	          'button',
	          { onClick: this.setCohort.bind(null, 39) },
	          '39'
	        ),
	        _react2.default.createElement(
	          'button',
	          { onClick: this.setCohort.bind(null, 40) },
	          '40'
	        ),
	        _react2.default.createElement(
	          'button',
	          { onClick: this.setCohort.bind(null, 41) },
	          '41'
	        )
	      );
	    }
